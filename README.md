 # Foundry Fund Me Course Project

This is an example project for the 7th Lesson of the Cyfrin Solidity Course.
...
```
git clone https://github.com/f3d0ss/foundry-fund-me-f23-course
cd foundry-fund-me-f23-course
forge build
```
...
or
```
forge script script/FundFundMe.s.sol --rpc-url sepolia  --private-key $SEPOLIA_PRIVATE_KEY  --broadcast
```
